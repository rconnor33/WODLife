    ...
    Public Partial Class InitialCreate
        ...
        Public Overrides Sub Up()
            ...
            CreateTable(
                ...
                Function(c) New With
                    {
                        .wodID = c.Int(nullable := False, identity := True),
                        .wodName = c.String(nullable := False),
                        .ApplicationUserID = c.String(maxLength := 128)
                    }) _
                .PrimaryKey(Function(t) t.wodID) _
                .ForeignKey("dbo.AspNetUsers", Function(t) t.ApplicationUserID) _
                .Index(Function(t) t.ApplicationUserID)
            
        End Sub
        
        Public Overrides Sub Down()
            DropForeignKey("dbo.Wods", "ApplicationUserID", "dbo.AspNetUsers")
            DropForeignKey("dbo.AspNetUserRoles", "UserId", "dbo.AspNetUsers")
            DropForeignKey("dbo.AspNetUserLogins", "UserId", "dbo.AspNetUsers")
            DropForeignKey("dbo.AspNetUserClaims", "UserId", "dbo.AspNetUsers")
            DropForeignKey("dbo.AspNetUserRoles", "RoleId", "dbo.AspNetRoles")
            DropIndex("dbo.Wods", New String() { "ApplicationUserID" })
